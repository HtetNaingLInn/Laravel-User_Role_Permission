<template>
  <div class="container">
    <div class="row">
      <!-- Create button Start -->
      <div class="col-md-6">
        <button v-on:click="createPermission" class="btn btn-primary my-2">Create Permission</button>
      </div>
      <!-- Create button End -->
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-header">
            <h5 class="text-info">{{editMode?"Edit Permission":"Create New Permission"}}</h5>
          </div>
          <div class="card-body">
            <alert-error :form="permission" v-bind:message="message"></alert-error>
            <form v-on:submit.prevent="editMode? updatePermission(): storePermission()">
              <div class="form-group">
                <input
                  ...
                  :class="{ 'is-invalid': permission.errors.has('name') }"
                />
